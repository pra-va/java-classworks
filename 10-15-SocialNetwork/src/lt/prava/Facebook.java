...
/**
 * Facebook social network implementation. This class is created in main class
...
public class Facebook implements SocialNetwork {
	...
	public void sendMessage(Client recipient, String message) {
		recipient.getApplicaiton().getNetworks()[0].getMessage("FACEBOOK " + message);
	}
	...
	public void getMessage(String message) {
		this.messages[messageIterator] = message;
